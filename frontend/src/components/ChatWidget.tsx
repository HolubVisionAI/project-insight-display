...
const ChatWidget = () => {
  ...
  // if no chat history yet, show one initial bot message
      ...
      return [
        {
          ...
          sender: "bot" as const,
          message:
            "Hi! I'm here to help answer any questions about Ihor's projects. What would you like to know?",
          timestamp: new Date(),
        },
      ];
    }
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-3">
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="max-w-[80%] p-3 rounded-lg bg-muted text-muted-foreground flex items-center space-x-2">
